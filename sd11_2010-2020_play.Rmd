...
precincts_2019_old <- readOGR( 
  dsn = paste0(getwd(),"/vtd_files/2019vtd/"), 
...
precincts_2018_old <- readOGR( 
  dsn = paste0(getwd(),"/vtd_files/2018vtd/"), 
...
precincts_2016_old <- readOGR( 
  dsn = paste0(getwd(),"/vtd_files/2016vtd/"), 
...
precincts_2014_old <- readOGR( 
  dsn = paste0(getwd(),"/vtd_files/2014vtd/"), 
...
precincts_2012_old <- readOGR( 
  dsn = paste0(getwd(),"/vtd_files/2012vtd/"), 
...
prec_2016 <- read.delim("precinct_level_state_leg/2016_reps.txt", 
...
ggplot(prec_elec_map_2018 %>% filter(MNSENDIST == "11"), aes(fill = R_perc)) + 
  geom_sf(color = "grey30", lwd = 0.25) + 
  theme_void() + scale_fill_gradient(low = "white", high = "red")
ggplot(prec_elec_map_2016 %>% filter(MNSENDIST == "11"), aes(fill = R_perc)) + 
  geom_sf(color = "grey30", lwd = 0.25) + 
  theme_void() + scale_fill_gradient(low = "white", high = "red")
ggplot(prec_elec_map_2014 %>% filter(MNSENDIST == "11"), aes(fill = R_perc)) + 
  geom_sf(color = "grey30", lwd = 0.25) + 
  theme_void() + scale_fill_gradient(low = "white", high = "red")
ggplot(prec_elec_map_2012 %>% filter(MNSENDIST == "11"), aes(fill = R_perc)) + 
  geom_sf(color = "grey30", lwd = 0.25) + 
  theme_void() + scale_fill_gradient(low = "white", high = "red")
...
prec_2018 <- read.delim("precinct_level_state_leg/2018_reps.txt", 
  sep = ";", header = FALSE, col.names = elec.col.names) %>% 
  mutate(precinct_num = sprintf("%04d", precinct_num))
...
prec_2014 <- read.delim("precinct_level_state_leg/2014_reps.txt", 
  sep = ";", header = FALSE, col.names = elec.col.names) %>% 
  mutate(precinct_num = sprintf("%04d", precinct_num))
...
prec_2012 <- read.delim("precinct_level_state_leg/2012_reps.txt", 
  sep = ";", header = FALSE, col.names = elec.col.names) %>% 
  mutate(precinct_num = sprintf("%04d", precinct_num))
