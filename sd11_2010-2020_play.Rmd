...
ggplot(rbind((prec_elec_map_2012_sen %>% mutate(column = "2012 ") %>% select(district:column)), 
             (prec_elec_map_2016_sen %>% mutate(column = "2016") %>% select(district:column)), 
             (prec_elec_map_2019_sen %>% mutate(column = "2019") %>% select(district:column))), 
